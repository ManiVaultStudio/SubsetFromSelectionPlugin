...
class SubsetFromSelectionPluginConan(ConanFile):
    ...
    name = "SubsetFromSelectionPlugin"
    description = """Plugins for displaying SubsetFromSelectionPlugin in ManiVaultStudio."""
    topics = ("hdps", "plugin", "image data", "loading")
    url = "https://github.com/ManiVaultStudio/SubsetFromSelectionPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/SubsetFromSelectionPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/SubsetFromSelectionPlugin")
        cmake.verbose = True
        return cmake
